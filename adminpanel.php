...
<form action="addcourse.php" method="get">
       <button type="submit"  class="links"><span class="glyphicon glyphicon-cog"></span>Add Course</button>
</form>
<form action="viewcourse.php" method="get">
       <button type="submit"  class="links"><span class="glyphicon glyphicon-cog"></span>Edit Course</button>
</form>
