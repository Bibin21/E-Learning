...
$result=mysqli_query($conn,"update exptable set name='$profilename' , age='$age' where fname='$fname'");
...
<br>
<form action="uploadnotes.php" method="get">
       <button type="submit"  class="links"><span class="glyphicon glyphicon-book"></span>Upload Notes
    <?php
...
<form action="viewnotes.php" method="get">
        <button type="submit"  class="links"><span class="glyphicon glyphicon-list-alt"></span>View Uploaded Notes</button>
</form>
</form>
    <form action="meet.php" method="get">
       <button type="submit"  class="links"><span class="glyphicon glyphicon-facetime-video"></span> Video chat</button>
</form>
<form action="chat2.php" method="get">
        <button type="submit"  class="links"><span class="glyphicon glyphicon-envelope"></span>Contact admin</button>
</form>
...
<input type="text" style="margin-bottom:10px;"  name="name" value='<?php echo "$name" ?>' id="name">
<br>
<label for="email">Email :</label>
<input type="text" style="margin-bottom:10px;"  readonly value='<?php echo "$email" ?>' id="email">
<br>
<label for="age">Age ㅤ:</label>
<input type="number" style="margin-bottom:10px;" name="age" value='<?php if($$age!=0) echo "$age" ?>' id="age">
<?php
...
?>
 <p><button type="submit" id="javascript" name="profilesubmit"  style="margin-top:20px;"  >Submit Edited Details</button></p>
</div>
    </div>
    </form>
    <br><br>
