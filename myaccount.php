...
<form action="myaccount.php" method="get">
...
<form action="notes.php" method="get">
    <button type="submit"  class="links"><span class="glyphicon glyphicon-book"></span>Notes
</form>
...
<input type="text" name="name" style="margin-bottom:10px;"  value='<?php echo "$name" ?>' id="name">
<br>
<label for="email">Email :</label>
<input type="text"  style="margin-bottom:10px;" readonly value='<?php echo "$email" ?>' id="email">
<br>
<label for="age">Age ㅤ:</label>
<input type="number" name="age" style="margin-bottom:10px;"  value='<?php if ($age !=0) echo "$age" ?>' id="age">
<?php
